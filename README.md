...
Recordemos que un **esquema conceptual** se basa en entender los datos que necesitamos almacenar sin entrar en detalle con la tecnología, mientras que el **esquema lógico** es la traducción de lo anterior a una **estructura de bases de datos real** con su debida implementación.
